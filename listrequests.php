                ...
                // echo "</pre>";
                    ...
                    if (count($output)>0) {
                        ...
                        <tr>
                            ...
                            <a href="grantrequest.php?requestid=<?php echo $request_id?>&firstname=<?php echo $value['firstname']; ?>&lastname=<?php echo $value['lastname']; ?>" class="btn btn-success" id="btnaccept">Accept</a>

                            <a href="deleterequest.php?requestid=<?php echo $request_id?>&firstname=<?php echo $value['firstname']; ?>&lastname=<?php echo $value['lastname']; ?>" class="btn btn-danger" id="btndecline">Decline</a>
