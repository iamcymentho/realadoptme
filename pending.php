...
<!-- Page Content -->
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">
      <small class="myheading text-muted text-decoration-underline" >Pending requests</small>
    </h1>
    ...
    <div class="row">
      ...
      <div class="card">
        <div class="card-header bg-secondary ">
            <h3 class="myadmintext text-white">List of pending requests</h3>
                    </div>
