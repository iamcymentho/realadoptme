...
<?php
      ...
      <div class="container">
        ...
        <div class="col-md-12 mb-3 backtodashboard">
       ...
       //create object of class
        ...
        $totalrequest = $obj->totalfosterrequests($_SESSION['fosterparent_id']);
            ?>

            <button type="button" class="btn btn-outline-primary move hdtext pad">
  Total requests <span class="badge bg-danger"><?php echo $totalrequest?></span>
</button>
      ...
      <div class="card w-75 mx-auto">
            ...
            <div class="card-title">
                <h3 class="htext mt-3 displaykidsheader text-decoration-underline">Request by <?php echo $_SESSION['fname']?> <?php echo $_SESSION['lname']?></h3>
    ...
    <div class="col shift">
       ...
       //create object of class
        ...
        $fosterrequest = $obj->fosterparentrequest($_SESSION['fosterparent_id']);
    ...
    // echo "</pre>";
        ...
        if (count($fosterrequest) > 0) {
            
            # loop thru the array using foreach
            foreach ($fosterrequest as $key => $value) {
                # code...
  ...
  <div class='progress-bar progress-bar-striped bg-primary progress-bar-animated' role='progressbar' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100' style='width: 5%'></div>
</div>";     

         $progresspending = "<div class='progress mt-3'>
  <div class='progress-bar progress-bar-striped bg-primary progress-bar-animated' role='progressbar' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100' style='width: 25%'></div>
</div>";

        $progressapproved = "<div class='progress mt-3'>
  <div class='progress-bar progress-bar-striped bg-primary progress-bar-animated' role='progressbar' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100' style='width: 65%'></div>
</div>";     
...
$progressdeclined = "<div class='progress mt-3'>
  <div class='progress-bar progress-bar-striped bg-primary progress-bar-animated' role='progressbar' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100' style='width: 15%'></div>
</div>";
